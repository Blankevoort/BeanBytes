...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/my-services', [ServiceController::class, 'getServices']);
    ...
    Route::post('/service/{id}/apply', [ServiceController::class, 'apply']);
    Route::post('/service/{serviceId}', [ServiceController::class, 'acceptApplicant']);
    Route::post('/service/{serviceId}', [ServiceController::class, 'rejectApplicant']);
});
